...
config_dir = ("/home/kasicka/.config/awesome/")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "1 FF", "2 IRC", "3 term", "4 docker", 5, 6, 7 }, s, layouts[1])
end
-- }}}
...
vicious.register(netwidget, vicious.widgets.net, function(widget, args)
    ...
    return '<span background="#C2C2A4" font="Inconsolata 15"> <span font ="Inconsolata 13" color="#FFFFFF">'..args["{"..interface.." down_kb}"]..'kbps'..'</span></span>' end, 10)
...
vicious.register( batwidget, vicious.widgets.bat, '<span background="#92B0A0" font="Inconsolata 15"><span font="Inconsolata 13" color="#FFFFFF" background="#92B0A0">$1$2% </span></span>', 1, "BAT0" )


--{{ Battery1 Widget }} --
baticon1 = wibox.widget.imagebox()
baticon1:set_image(beautiful.baticon)

batwidget1 = wibox.widget.textbox()
vicious.register( batwidget1, vicious.widgets.bat, '<span background="#92B0A0" font="Inconsolata 15"><span font="Inconsolata 13" color="#FFFFFF" background="#92B0A0">$1$2% </span></span>', 1, "BAT1" )

--{{---| File Size widget |-----
fswidget = wibox.widget.textbox()

vicious.register(fswidget, vicious.widgets.fs,
'<span background="#D0785D" font="Inconsolata 15"> <span font="Inconsolata 13" color="#EEEEEE">${/home used_gb}/${/home avail_gb} GB </span></span>', 
800)
...
'<span background="#4B3B51" font="Inconsolata 15"><span font="Inconsolata 13" color="#EEEEEE"> Vol:$1 </span></span>', 0.5, "Master")
...
'<span background="#4B696D" font="Inconsolata 15"> <span font="Inconsolata 13" color="#DDDDDD">$2%<span color="#888888">·</span>$3% </span></span>', 1)
...
vicious.register(memwidget, vicious.widgets.mem, '<span background="#777E76" font="Inconsolata 15"> <span font="Inconsolata 13" color="#EEEEEE" background="#777E76">$2MB </span></span>', 1)
...
--awful.key({ "Control", "Shift"}, "Escape", function() awful.util.spawn("reboot") end),
...
awful.key({ "Control", "Shift"}, "b", function() 
    awful.util.spawn("/opt/sublime-text/sublime_text") end),
